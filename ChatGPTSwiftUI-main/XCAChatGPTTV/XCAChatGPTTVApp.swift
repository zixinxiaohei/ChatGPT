...
struct XCAChatGPTTVApp: App {
    ...
    @StateObject var vm = ViewModel(api: ChatGPTAPI(apiKey: "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"), enableSpeech: true)
    ...
    var body: some Scene {
        WindowGroup {
            VStack {
                Text("DW ChatGPT").font(.largeTitle)
